...
read_tsv("09-MaAsLin/01-input/metadata-v5-2yr-EDSS-50subjectPool.tsv") %>%
  ...
  filter(sex == "Females") %>%
  write_tsv("../01-NOMMS_Final_qiime_v202309/09-MaAsLin/01-input/metadata-v5-2yr-EDSS-38femalesPool-nostril.tsv")
...
dir.create("09-MaAsLin/03-output/01-nostril/l6taxa/female-edss_change/")
