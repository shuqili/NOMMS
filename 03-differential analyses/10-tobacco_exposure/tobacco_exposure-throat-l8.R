...
dir.create("09-MaAsLin/03-output/03-throat/ASVlevel/tobacco_exposure + [age + sex + bmi ]")
fit_data_4 = Maaslin2::Maaslin2(output = "09-MaAsLin/03-output/03-throat/ASVlevel/tobacco_exposure + [age + sex + bmi ]/cplmfit-no-transformation-relab-asv-to-diseasestat/", 
