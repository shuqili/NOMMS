...
dir.create("09-MaAsLin/03-output/01-nostril/l6taxa/tobacco_exposure + [age + sex + bmi ]")
fit_data_4 = Maaslin2::Maaslin2(output = "09-MaAsLin/03-output/01-nostril/l6taxa/tobacco_exposure + [age + sex + bmi ]/cplmfit-no-transformation-relab-asv-to-diseasestat/", 
