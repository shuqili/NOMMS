...
# fit_data_1 = Maaslin2(output = "09-MaAsLin/03-output/02-gums/lmfit-ast-transformed-relab-asv-to-diseasestat",
...
# 
# 
# fit_data_2 = Maaslin2(output = "09-MaAsLin/03-output/02-gums/lmfit-log-transformed-relab-asv-to-diseasestat", 
#                       input_data     = df_input_data, 
#                       input_metadata = df_input_metadata, 
#                       analysis_method = "LM",
#                       normalization  = "NONE",
...
#                                          "smoking"))
# 
# fit_data_3 = Maaslin2(output = "09-MaAsLin/03-output/02-gums/lmfit-logit-transformed-relab-asv-to-diseasestat", 
#                       input_data     = df_input_data, 
#                       input_metadata = df_input_metadata, 
#                       analysis_method = "LM",
#                       normalization  = "NONE",
...
#                       fixed_effects  = c("age","sex","bmi",
#                                          "smoking"))
dir.create("09-MaAsLin/03-output/02-gums/l6taxa/Smoking_YN + [age + sex + bmi ]")
fit_data_4 = Maaslin2::Maaslin2(output = "09-MaAsLin/03-output/02-gums/l6taxa/Smoking_YN + [age + sex + bmi ]/cplmfit-no-transformation-relab-asv-to-diseasestat/", 
                      input_data     = df_input_data, 
                      input_metadata = df_input_metadata, 
